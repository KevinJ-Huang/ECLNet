...
def main():
    ...
    parser.add_argument('--opt', type=str, default='/home/jieh/Projects/DualRelu/DualRelu/options/train/train_Enhance.yml',
    ...
    # # #
        ...
        if opt['datasets'].get('val', None) and epoch % opt['train']['val_epoch'] == 0:
            ...
            for val_data in val_loader:
                ...
                model.test(img_name.split('/')[-1],img_name.split('/')[-2])
            ...
            # log
            logger.info('# Validation # Low PSNR: {:.4e}'.format(avg_psnr_exp2 / 30.0))
            logger.info('# Validation # Over PSNR: {:.4e}'.format(avg_psnr_exp1 / 30.0))
            logger.info(
